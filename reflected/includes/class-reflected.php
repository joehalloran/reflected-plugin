...
class Reflected {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-reflected-loader.php';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Reflected_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Reflected_Public( $this->get_plugin_name(), $this->get_version() );
